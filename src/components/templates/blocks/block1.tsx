  ...
  return (
    <section id="block-1" className="template">
      <div className="mx-auto max-w-screen-xl">
        ...
        <h2 className="heading-05 max-w-5xl">{data.heading}</h2>
        <p className="paragraph-03 max-w-3xl">{data.blurb1}</p>
        <p className="paragraph-03 max-w-3xl mb-8">{data.blurb2}</p>
        {data.buttonLinks &&
