      ...
      <section className="p-4 border-b border-light-03 dark:border-dark-02">
        <div className="max-w-screen-xl mx-auto">
          <nav className="flex flex-wrap items-center">
              ...
              {menuItems &&
                menuItems.map((menuItem: any) => {
                  return (
                    ...
                    >
                      <Link
                        className="flex justify-center w-full p-3 text-gray-600 transition duration-200 ease-in-out rounded-corner-02 dark:text-02 hover:text-dark-04 hover:bg-secondary dark:hover:text-dark-03 md:w-auto"
                        href={menuItem.url}
                      >
                        {menuItem.label}
                      </Link>
            ...
            >
              <div className="relative w-12 h-12 transition-colors duration-200 ease-in-out rounded-corner-02 bg-accent hover:bg-accent-hover">
                <svg
                  className={
